package com.example.customtouch.Utils;
...
public class SettingSharedPref {
    ...
    public static SettingSharedPref getInstance(Context context) {
        if (instance == null) {
    ...
    public int getBtnHomeTheme() {
        return mSharedPreferences.getInt(BTN_HOME_THEME, R.drawable.hb_blue);
    }
